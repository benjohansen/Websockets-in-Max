...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 312.0, 477.646794250764515, 108.0, 24.0 ],
					"text" : "recieve a bang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 286.0, 477.646794250764515, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 238.0, 531.5, 101.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 247.5, 466.0, 295.5, 466.0 ],
					"order" : 0,
					"source" : [ "obj-110", 0 ]
				}
...
, 			{
				"name" : "max-client.js",
				"bootpath" : "~/Library/CloudStorage/Dropbox/_web-to-max/_max-websockets/part3_objects/max-client",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
