...
,
		"classnamespace" : "box",
		"rect" : [ 1364.0, 192.0, 1053.0, 760.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 238.0, 586.5, 101.0, 22.0 ],
...
, 			{
				"name" : "max-client.js",
				"bootpath" : "~/Library/CloudStorage/Dropbox/_web-to-max/_max-websockets/part2_simple-chat/max-client",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
